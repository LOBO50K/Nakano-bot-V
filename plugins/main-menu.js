...
await m.react('⭐️') 
  ...
  await conn.sendButton(m.chat, text.trim(), `*${saludo}*`, imagen1, [['Iɴғᴏ📌', '.infobot'], ['Cʀᴇᴀᴅᴏʀ🐢', '.owner']], false, { quoted: m, contextInfo: { mentions: [who], externalAdReply: { showAdAttribution: true, mediaType: 'VIDEO', mediaUrl: '', title: packname, body: dev, thumbnail: miniurl, sourceUrl: channel }}})
