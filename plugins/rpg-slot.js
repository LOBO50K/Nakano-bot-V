...
if (new Date - users.lastslot < 10000) throw `⏱️ Espere ${msToTime(time - new Date())}`
if (apuesta < 100) throw '🚩 Mínimo de la apuesta es *100 XP*'
...
return await conn.reply(m.chat, `🎰 | *SLOTS* 
──────────
${x[0]} : ${y[0]} : ${z[0]}
${x[1]} : ${y[1]} : ${z[1]}
${x[2]} : ${y[2]} : ${z[2]}
